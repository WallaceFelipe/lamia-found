...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li <?php if ($_GET['p'] == 'projeto_consultar') echo "class='active'"; ?> ><a href="index.php?p=projeto_consultar"><svg class="glyph stroked star"><use xlink:href="#stroked-star"/></svg>Consultar projetos aprovados</a> </li>
