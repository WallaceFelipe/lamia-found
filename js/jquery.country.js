(function ($) {
    ...
    $.countrify = function (countryElement, stateElement, cityElement, options) {
        ...
        initialize = function () {
            ...
            $.getJSON('js/data/countries.json', function (countries) {
        ...
        onCountryChange = function () {
            ...
            $.getJSON('js/data/' + countryElement.val().toLowerCase() + '/states.json', function (states) {
        ...
        onStateChange = function () {
            ...
            $.get('js/data/' + countryElement.val().toLowerCase() + '/cities.json', function (cities) {
